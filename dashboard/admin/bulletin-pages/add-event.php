<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $uploadDirectory = $_SERVER['DOCUMENT_ROOT'] . "/Resources/events/";
        ...
        $photoPathDB = "/Resources/events/" . $newFileName;


        try {
            $stmt = $mysqli->prepare("INSERT INTO events (title, caption, image) VALUES (?, ?, ?)");
